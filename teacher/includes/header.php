  ...
  ?>
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-between flex-grow-1 flex-wrap px-3">
        <h6 class="mb-0 font-weight-medium d-none d-md-inline" style="color: white;">
          <?php echo htmlentities($row->TeacherName); ?> - Welcome to dashboard!
        </h6>
        ...
        <ul class="navbar-nav navbar-nav-right d-flex align-items-center ml-auto">
          <li class="nav-item dropdown user-dropdown position-relative">
            <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="UserDropdown" role="button" data-toggle="dropdown" aria-expanded="false">
              ...
              <span class="font-weight-normal ml-2" style="color: white;"><?php echo htmlentities($row->TeacherName); ?></span>
            </a>

            <div class="dropdown-menu dropdown-menu-right navbar-dropdown shadow" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                <img class="img rounded-circle mb-2" style="width: 80px; height: 80px;" src="../admin/images/<?php echo $row->Image; ?>" alt="Profile image">
                <p class="mb-1 mt-1 font-weight-bold"><?php echo htmlentities($row->TeacherName); ?></p>
